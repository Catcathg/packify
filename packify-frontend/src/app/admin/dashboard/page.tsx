            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <div className="space-y-6">
                    ...
                    <Link href="/admin/packs" className="block">
                        <div className="bg-gray-800 rounded-3xl p-8 hover:bg-opacity-80 transition-all duration-300 cursor-pointer group">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-gray-800 rounded-2xl p-6 text-center">
                        <div className="text-2xl font-bold text-pink-500 mb-2">12</div>
                        <div className="text-gray-400">Activités disponibles</div>
                    </div>
                    <div className="bg-gray-800 rounded-2xl p-6 text-center">
                        <div className="text-2xl font-bold text-pink-500 mb-2">247</div>
                        <div className="text-gray-400">Packs vendus</div>
                    </div>
                    <div className="bg-gray-800 rounded-2xl p-6 text-center">
                        <div className="text-2xl font-bold text-pink-500 mb-2">89</div>
